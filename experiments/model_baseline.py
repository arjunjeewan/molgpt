"""
BASELINE MolGPT/LigGPT architecture (verbatim original): learned absolute position
embedding, standard GELU bottleneck FFN, LayerNorm. Used to isolate the effect of the
RoPE + SwiGLU + RMSNorm modernization. Not part of the repo's train/generate path.
"""
